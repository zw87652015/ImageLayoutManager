...
_T: dict[str, dict[str, str]] = {
    "action_align_plots": {"en": "Align Plot Areas…", "zh": "对齐绘图区…"},
    "tooltip_align_plots": {"en": "Mark plot interiors manually, then match their height and bottom baseline without changing source files or cell slots.", "zh": "手动标记绘图区，统一高度并对齐底部基线，不修改源文件或单元格位置。"},
    "plot_new_group": {"en": "New group", "zh": "新建对齐组"},
    "plot_new_group_tooltip": {"en": "Create an alignment group, name it, then check the panels to include.", "zh": "创建一个对齐组，先命名，再勾选要包含的面板。"},
    "plot_delete_group": {"en": "Delete group", "zh": "删除对齐组"},
    "plot_group_name_prompt": {"en": "Name for the new alignment group:", "zh": "新对齐组的名称："},
    "plot_no_groups": {"en": "No alignment group selected", "zh": "未选择对齐组"},
    "plot_no_groups_status": {"en": "No alignment group is selected. Click New group to create one, or choose an existing group above.", "zh": "尚未选择对齐组。点击“新建对齐组”创建，或在上方选择已有的对齐组。"},
    "plot_guide_create_group": {"en": "Click New group and name it, then check the panels to include.", "zh": "点击“新建对齐组”并命名，然后勾选要包含的面板。"},
    "plot_guide_apply_changes": {"en": "Apply to save the alignment changes, or choose a group above to keep editing.", "zh": "点击应用保存对齐更改，或在上方选择对齐组继续编辑。"},
    "plot_guide_new_group": {"en": "Check at least two panels to include in {name}.", "zh": "请勾选至少两个要加入 {name} 的面板。"},
    "plot_group_name": {"en": "Plot alignment {n}", "zh": "绘图区对齐 {n}"},
    "plot_group": {"en": "Alignment", "zh": "对齐组"},
    "plot_group_name_hint": {"en": "Alignment name", "zh": "对齐组名称"},
    "plot_more_members": {"en": " +{count}", "zh": " 等 {count} 项"},
    "plot_will_remove_suffix": {"en": " (will be removed)", "zh": "（将被移除）"},
    "plot_move_hint": {"en": "Belongs to {name}. Check to move it into this alignment.", "zh": "属于 {name}。勾选即可将其移入当前对齐组。"},
    "plot_moved_from": {"en": "Moved {panels} from {name}. Uncheck to put it back.", "zh": "已将 {panels} 从 {name} 移入。取消勾选可移回。"},
    "plot_auto_removed": {"en": "{name} will be removed: fewer than two panels remain.", "zh": "{name} 将被移除：剩余面板少于两个。"},
    "plot_apply_summary": {"en": "Apply will update {count} alignments: {names}.", "zh": "应用将更新 {count} 个对齐组：{names}。"},
    "plot_selection_spans": {"en": "Selection spans {count} alignments; editing {name}. Switch above to edit another.", "zh": "所选面板分属 {count} 个对齐组；当前编辑 {name}。可在上方切换编辑其他组。"},
    "plot_alignment_none": {"en": "None", "zh": "无"},
    "plot_alignment_members": {"en": "{name} · {count} panels", "zh": "{name} · {count} 个面板"},
    "plot_alignment_edit": {"en": "Edit…", "zh": "编辑…"},
    "plot_alignment_create": {"en": "Align…", "zh": "对齐…"},
    "lbl_plot_alignment": {"en": "Plot alignment:", "zh": "绘图区对齐:"},
    "plot_panel": {"en": "Image panel", "zh": "图像面板"},
    "plot_state": {"en": "Status", "zh": "状态"},
    "plot_row": {"en": "Baseline", "zh": "基线组"},
    "plot_reference": {"en": "Reference", "zh": "参照图"},
    "plot_ready": {"en": "Ready", "zh": "已标记"},
    "plot_unmarked": {"en": "Not marked", "zh": "未标记"},
    "plot_sizing": {"en": "Plot height", "zh": "绘图区高度"},
    "plot_exact": {"en": "Match reference exactly", "zh": "精确匹配参照图"},
    "plot_fit": {"en": "Fit within cells", "zh": "适应单元格边界"},
    "plot_baselines": {"en": "Bottom baselines", "zh": "底部基线"},
    "plot_grid_rows": {"en": "Grid rows", "zh": "按网格行"},
    "plot_single": {"en": "One baseline", "zh": "同一基线"},
    "plot_custom": {"en": "Custom rows", "zh": "自定义分行"},
    "plot_mark_help": {"en": "Check at least two panels. Draw each plot interior, excluding axis labels and titles. This is a marker, not a crop: labels remain. No automatic axis detection.", "zh": "勾选至少两个面板，手动框选绘图区内部，不包含坐标标签和标题。这是标记而非裁剪，标签会保留；不会自动检测坐标轴。"},
    "plot_source_help": {"en": "Full, unrotated source · drag to mark; edges/corners resize; inside moves. Wheel zooms; middle button or Space-drag pans.", "zh": "完整未旋转源图 · 拖动标记，拖动边角调整，内部拖动移动。滚轮缩放，中键或空格拖动平移。"},
    "plot_rotated": {"en": "Panel rotation: {degrees}°. Mark the unrotated source shown here.", "zh": "面板旋转：{degrees}°。请在此处显示的未旋转源图上标记。"},
    "plot_redraw": {"en": "Redraw", "zh": "重画"},
    "plot_clear": {"en": "Clear mark", "zh": "清除标记"},
    "plot_next": {"en": "Next unmarked", "zh": "下一个未标记"},
    "plot_source": {"en": "Mark source", "zh": "标记源图"},
    "plot_preview": {"en": "Preview alignment", "zh": "预览对齐"},
    "plot_preview_help": {"en": "Figure preview only · green guides show plot areas and bottom baselines; red indicates conflicts. Wheel zooms; middle button or Space-drag pans. Switch to Mark source to edit.", "zh": "仅预览成图 · 绿色辅助线表示绘图区和底部基线，红色表示冲突。滚轮缩放，中键或空格拖动平移；切换到标记源图可继续编辑。"},
    "plot_fit_view": {"en": "Show whole image", "zh": "显示完整图像"},
    "plot_fit_figure_view": {"en": "Show whole figure", "zh": "显示完整成图"},
    "plot_fit_view_tooltip": {"en": "Reset preview zoom and pan only; this does not resize plots or make them fit their cells.", "zh": "仅重置预览的缩放和平移；不会调整绘图区大小，也不会使其适应单元格边界。"},
    "plot_fit_plots": {"en": "Fit plots within cells", "zh": "适应单元格边界"},
    "plot_fit_plots_tooltip": {"en": "The plots were already reduced to a common plot height so every panel fits its cell. Switch this alignment to Fit within cells to make that setting explicit and preview it. Aspect ratios, cell geometry and labels are preserved. Apply to confirm.", "zh": "绘图区已按共同高度缩小以使每个面板适应单元格。将此对齐组切换为“适应单元格边界”以明确该设置并预览。保留宽高比、单元格位置和尺寸以及标签。点击应用确认。"},
    "plot_marked_count": {"en": "Marked {marked} of {selected} selected panels", "zh": "已标记 {marked} / {selected} 个已选面板"},
    "plot_does_not_fit": {"en": "Does not fit", "zh": "超出边界"},
    "plot_needs_attention": {"en": "Needs attention", "zh": "需要处理"},
    "plot_remove": {"en": "Remove alignment", "zh": "移除对齐"},
    "plot_remove_note": {"en": "Normal image fitting will be restored; marked areas retained. Apply to confirm, or Cancel to keep the alignment.", "zh": "将恢复普通图像适配，保留绘图区标记。点击应用确认；取消则保留原对齐。"},
    "plot_restore": {"en": "Keep alignment", "zh": "保留对齐"},
    "plot_target": {"en": "Target plot height: {height} mm", "zh": "目标绘图区高度：{height} mm"},
    "plot_exact_note": {"en": "Height only; aspect ratio preserved. The reference keeps its placement while every panel fits its cell; if the exact size would cut off any panel, the whole group shrinks to fit and a notice is shown. Cell slots stay fixed in both layout modes.", "zh": "仅匹配高度，始终保持宽高比。在所有面板都能容纳的前提下，参照图位置和大小不变；若精确尺寸会裁掉任一面板的内容，整组会缩小以适应并给出提示。两种布局下单元格均保持固定。"},
    "plot_fit_note": {"en": "Height only; aspect ratio preserved. Fits the available cell content without changing cell slots. The reference may shrink or move.", "zh": "仅匹配高度，始终保持宽高比。适应单元格内可用空间，不改变单元格位置和尺寸；参照图可能缩小或移动。"},
    "plot_rows_note": {"en": "Each grid row keeps a separate bottom baseline.", "zh": "各网格行分别对齐底部基线。"},
    "plot_custom_note": {"en": "Panels with the same Baseline number share one bottom axis. The suggested numbers follow current vertical positions; type new ones to regroup.", "zh": "“基线组”编号相同的面板共用一条底部基线。建议编号依据当前垂直位置；可输入新编号重新分组。"},
    "plot_single_note": {"en": "All checked panels share one bottom baseline; use separate baseline groups for multi-row figures.", "zh": "所有勾选面板共用一条底部基线；多行图请使用不同的基线组。"},
    "plot_need_two": {"en": "Check at least two image panels, then mark their plot areas.", "zh": "请勾选至少两个图像面板，再标记各自绘图区。"},
    "plot_need_marks": {"en": "Mark every checked panel ({count} still unmarked). Select a panel and draw its plot interior.", "zh": "请标记所有勾选面板（还有 {count} 个未标记）。选择面板并框选绘图区内部。"},
    "plot_valid": {"en": "Ready to apply. Preview uses a separate copy; Cancel changes nothing. Green boxes and dashed bottom baselines are guides only.", "zh": "可以应用。预览使用独立副本，取消不会更改项目。绿色框及虚线底部基线仅为辅助线。"},
    "plot_attention": {"en": "Plot alignment needs attention: {issues}", "zh": "绘图区对齐需要处理：{issues}"},
    "plot_export_blocked": {"en": "Figure export is blocked until plot alignment is repaired or removed. Source-image export and project saving are still available.", "zh": "请修复或移除绘图区对齐后再导出成图。仍可保存项目或导出源图像。"},
    "plot_issue_missing_source": {"en": "Source file missing or unreadable", "zh": "源文件缺失或无法读取"},
    "plot_issue_invalid_area": {"en": "Plot area missing or invalid", "zh": "绘图区标记缺失或无效"},
    "plot_issue_source_changed": {"en": "Source changed — redraw the mark", "zh": "源图已更改，请重新标记"},
    "plot_issue_missing_reference": {"en": "Choose a checked reference panel", "zh": "请选择已勾选的参照面板"},
    "plot_issue_missing_member": {"en": "Group contains a missing panel — uncheck it to repair", "zh": "组内面板已缺失，请取消勾选以修复"},
    "plot_issue_duplicate_member": {"en": "Panel belongs to another alignment — remove that membership first", "zh": "面板已属于另一对齐组，请先移除原组中的成员关系"},
    "plot_issue_cropped_area": {"en": "Plot area extends outside the current crop", "zh": "绘图区超出当前裁剪范围"},
    "plot_issue_overflow": {"en": "Exact reference overflows a cell — choose Fit or adjust the layout", "zh": "精确匹配超出单元格，请选择适应边界或调整布局"},
    "plot_issue_reduced_to_fit": {"en": "{name}: the reference size does not fit every cell, so the plots were reduced to {height} mm to keep all content visible. Enlarge the cells to restore the exact reference size.", "zh": "{name}：参照图尺寸无法适应每个单元格，绘图区已缩小至 {height} mm 以保证内容完整可见。放大单元格可恢复精确参照尺寸。"},
    "plot_notice": {"en": "Plot alignment: {issues}", "zh": "绘图区对齐：{issues}"},
    "plot_issue_no_space": {"en": "No room for aligned plots within these cells", "zh": "这些单元格内没有足够空间对齐绘图区"},
    "plot_issue_invalid_rows": {"en": "Type a baseline number (0 or greater) for every checked panel", "zh": "请为每个勾选面板输入非负整数基线组编号"},
    "plot_more_issues": {"en": "… and {count} more", "zh": "……另有 {count} 项"},
    "plot_missing_panel": {"en": "Missing panel ({id})", "zh": "缺失面板（{id}）"},
    "plot_apply": {"en": "Apply", "zh": "应用"},
    "plot_cancel": {"en": "Cancel", "zh": "取消"},
    "plot_stage_select": {"en": "Select", "zh": "选择"},
    "plot_stage_mark": {"en": "Mark", "zh": "标记"},
    "plot_stage_match": {"en": "Match", "zh": "匹配"},
    "plot_stage_apply": {"en": "Apply", "zh": "应用"},
    "plot_stage_current": {"en": "current suggestion", "zh": "当前建议"},
    "plot_stage_complete": {"en": "complete", "zh": "已完成"},
    "plot_stage_pending": {"en": "next", "zh": "后续"},
    "plot_guide_stages": {"en": "Alignment progress — suggested steps, not required gates", "zh": "对齐进度：建议步骤，并非强制顺序"},
    "plot_example": {"en": "Example", "zh": "示例"},
    "plot_example_tooltip": {"en": "Examples: what to box and what alignment means", "zh": "示例：框选哪里，以及对齐的含义"},
    "plot_details": {"en": "Details", "zh": "详情"},
    "plot_details_tooltip": {"en": "Read all warnings and alignment instructions", "zh": "查看全部警告和对齐说明"},
    "plot_example_mark": {"en": "What to box", "zh": "框选哪里"},
    "plot_example_alignment": {"en": "What alignment means", "zh": "对齐的含义"},
    "plot_example_caption": {"en": "Example — not your image", "zh": "示例图，并非您的图像"},
    "plot_box_plot": {"en": "Box the plot", "zh": "框选绘图区"},
    "plot_keep_labels": {"en": "Keep labels outside", "zh": "标签留在框外"},
    "plot_axis_x": {"en": "X axis", "zh": "X 轴"},
    "plot_axis_y": {"en": "Y axis", "zh": "Y 轴"},
    "plot_same_height": {"en": "Same height", "zh": "相同高度"},
    "plot_same_bottom": {"en": "Same bottom line", "zh": "同一底线"},
    "plot_diagram_mark_description": {"en": "Example only, not your source. Drag from corner 1 to corner 2 across the cyan inner plotting rectangle. X and Y ticks, axis titles and labels stay outside the box. Marking does not crop or remove them.", "zh": "仅为示例，并非您的源图。沿对角线从角点 1 拖至角点 2，框住青色的内部绘图区。X、Y 轴刻度、轴标题及标签留在框外。标记不会裁剪或移除它们。"},
    "plot_diagram_alignment_description": {"en": "Example only. Two plot frames have different widths but the same height, shown by a vertical double arrow. The left frame is the reference. Both bottoms meet the same dashed line. Aspect ratios and source content are preserved.", "zh": "仅为示例。两个绘图框宽度不同，高度相同，垂直双向箭头表示共同高度。左框为参照图，两个框底部对齐同一虚线。保留宽高比和源图内容。"},
    "plot_mark_next": {"en": "Mark next image", "zh": "标记下一张"},
    "plot_gesture_hint": {"en": "Drag box · Wheel zoom · Middle-drag pan", "zh": "拖动框选 · 滚轮缩放 · 中键拖动平移"},
    "plot_rotation_hint": {"en": "Rotated {degrees}° in figure; mark this unrotated source.", "zh": "成图旋转 {degrees}°；请标记此未旋转源图。"},
    "plot_preview_hint": {"en": "Preview only · Compare the dashed bottom lines", "zh": "仅为预览 · 对比虚线底部基线"},
    "plot_guide_select": {"en": "Check at least two images on the left.", "zh": "请在左侧勾选至少两张图像。"},
    "plot_guide_mark": {"en": "Draw a box around this plot — leave labels outside.", "zh": "框住此图的绘图区，标签留在框外。"},
    "plot_guide_changed": {"en": "This source changed — mark it again.", "zh": "此源图已更改，请重新标记。"},
    "plot_guide_next": {"en": "Mark the next checked image.", "zh": "请标记下一张已勾选图像。"},
    "plot_guide_next_changed": {"en": "Another source changed. Mark the next image again.", "zh": "另一源图已更改，请重新标记下一张。"},
    "plot_guide_reference": {"en": "Choose a reference image to match.", "zh": "请选择用于匹配的参照图。"},
    "plot_guide_rows": {"en": "Type a baseline number for every checked image.", "zh": "请为每张勾选图像输入基线组编号。"},
    "plot_guide_preview": {"en": "Reference: {name}. Preview the alignment next.", "zh": "参照图：{name}。接下来预览对齐效果。"},
    "plot_guide_apply": {"en": "Check the bottom lines, then Apply. Save the project afterwards.", "zh": "检查底线后点击应用，之后请保存项目。"},
    "plot_guide_remove": {"en": "Apply to restore normal image fitting; keep the marks.", "zh": "点击应用，恢复普通图像适配并保留标记。"},
    "plot_guide_other": {"en": "Another alignment needs attention. Select it above; see Details.", "zh": "另一对齐组需要处理。请在上方选择该组，查看详情。"},
    "plot_guide_review": {"en": "Review the checked images; see Details for what to fix.", "zh": "请检查勾选的图像，在详情中查看修复方法。"},
    "plot_guide_issue_missing_source": {"en": "Source unavailable — uncheck that image or restore its file.", "zh": "源图无法读取，请取消勾选或恢复其文件。"},
    "plot_guide_issue_invalid_area": {"en": "An image or alignment setting is invalid — review Details.", "zh": "图像或对齐设置无效，请查看详情。"},
    "plot_guide_issue_source_changed": {"en": "A source changed — select it and mark it again.", "zh": "源图已更改，请选中并重新标记。"},
    "plot_guide_issue_missing_reference": {"en": "Choose a checked reference image.", "zh": "请选择已勾选的参照图。"},
    "plot_guide_issue_missing_member": {"en": "A panel is missing — uncheck its row.", "zh": "面板已缺失，请取消勾选该行。"},
    "plot_guide_issue_duplicate_member": {"en": "A plot belongs to another alignment — review checked images.", "zh": "绘图区已属于另一对齐组，请检查勾选的图像。"},
    "plot_guide_issue_cropped_area": {"en": "A mark extends outside its crop — review that image and Details.", "zh": "标记超出裁剪范围，请检查该图像并查看详情。"},
    "plot_guide_issue_overflow": {"en": "Some plots need more space — review images and Details.", "zh": "部分绘图区空间不足，请检查图像并查看详情。"},
    "plot_guide_issue_no_space": {"en": "Some plots need more space — review the bottom baselines.", "zh": "部分绘图区空间不足，请检查底部基线设置。"},
    "plot_guide_issue_invalid_rows": {"en": "Review the baseline numbers for every checked image.", "zh": "请检查每张勾选图像的基线组编号。"},
    # ── Menus ────────────────────────────────────────────────────────
    ...
    "action_export_sources": {"en": "Export All Source Images…", "zh": "导出全部源图片…"},
    "tooltip_export_sources": {
        "en": "Copy the current project's original image files, including nested subcells and external PiP images, in their original formats. No layout, crops, annotations, or text edits are applied.",
        "zh": "按原始格式复制当前项目使用的原始图片文件，包括嵌套子单元格和外部画中画图片；不应用布局、裁剪、标注或文字修改。",
    },
    ...
    "lbl_image_format":     {"en": "Source Format:",    "zh": "源文件格式:"},
    "fmt_vector":           {"en": "{name} · vector", "zh": "{name} · 矢量"},
    "fmt_vector_tip":       {"en": "Vector source: text and lines stay sharp at any export size.",
                             "zh": "矢量源文件：无论导出尺寸多大，文字和线条都保持清晰。"},
    "fmt_raster":           {"en": "{name} · {w}×{h} px", "zh": "{name} · {w}×{h} px"},
    "fmt_raster_tip":       {"en": "Raster source: {w}×{h} pixels. Detail is fixed by the file; a higher export DPI cannot add detail that is not there.",
                             "zh": "位图源文件：{w}×{h} 像素。细节由文件本身决定；提高导出 DPI 不会增加文件中不存在的细节。"},
    "fmt_raster_unknown":   {"en": "{name} · raster", "zh": "{name} · 位图"},
    "fmt_missing":          {"en": "{name} · file not found", "zh": "{name} · 文件不存在"},
    "fmt_missing_tip":      {"en": "The source file is not at its saved location. Reimport it, or open a bundle that contains it.",
                             "zh": "源文件不在保存的位置。请重新导入，或打开包含该文件的工程包。"},
    "fmt_none":             {"en": "No image", "zh": "无图片"},
    ...
    "dlg_export_sources": {"en": "Export Source Images", "zh": "导出源图片"},
    "dlg_export_sources_folder": {"en": "Choose Folder for Source Images", "zh": "选择源图片导出文件夹"},
    "dlg_copying_source": {"en": "Copying {filename}…", "zh": "正在复制 {filename}…"},
    "msg_export_sources_empty": {
        "en": "No source images are used in the current project.",
        "zh": "当前项目未使用任何源图片。",
    },
    "msg_export_sources_done": {
        "en": "Copied {count} source image(s) in their original formats to:\n{folder}",
        "zh": "已按原始格式复制 {count} 张源图片到：\n{folder}",
    },
    "msg_export_sources_partial": {
        "en": "Copied {count} source image(s); {failed} could not be copied.\nFolder: {folder}\nSee details for all failed references.",
        "zh": "已复制 {count} 张源图片；{failed} 张无法复制。\n文件夹：{folder}\n请查看详细信息中的全部失败引用。",
    },
    "msg_export_sources_cancelled": {
        "en": "Source image export cancelled. Copied {count} image(s); {failed} failed.\nCompleted files remain in:\n{folder}",
        "zh": "源图片导出已取消。已复制 {count} 张图片；{failed} 张失败。\n已完成的文件保留在：\n{folder}",
    },
    "msg_export_sources_failed": {
        "en": "Could not export source images:\n{error}",
        "zh": "无法导出源图片：\n{error}",
    },
    ...
    # ── Help dialog ───────────────────────────────────────────────
    "tutorials_title":      {"en": "Guided Tutorials…", "zh": "引导教程…"},
    "tutorials_welcome":    {"en": "Learn to use ILM", "zh": "学习如何使用ILM"},
    "tutorials_practice":   {"en": "Practice", "zh": "练习"},
    ...
    "help_tab_cells":       {"en": "Layout",            "zh": "布局"},
    "help_tab_labels":      {"en": "Labels",            "zh": "标注"},
    "help_tab_typography":  {"en": "Text Sizes",        "zh": "文字大小"},
    "help_tab_export":      {"en": "Export",            "zh": "导出"},
    "help_tab_advanced":    {"en": "Preferences",       "zh": "偏好设置"},
    "help_tab_shortcuts":   {"en": "Shortcuts",         "zh": "快捷键"},
    "help_shortcuts_hint":  {"en": "Windows shortcuts are listed below. On other platforms, check the shortcut shown in the menu. Canvas navigation requires canvas focus, not a text field.",
                             "zh": "以下列出 Windows 快捷键。其他平台请以菜单显示为准。画布导航需要画布获得焦点，而不是文本输入框。"},
    ...
    "about_license_summary": {"en": "Apache-2.0 source; GPL/AGPL bundle",
                             "zh": "源码：Apache-2.0；组合发行包：GPL/AGPL"},
    "about_licenses":       {"en": "Licenses and source…",
                             "zh": "许可协议与源码…"},
    "licenses_title":       {"en": "Licenses and source",
                             "zh": "许可协议与源码"},
    "licenses_notice":      {"en": "You may modify and redistribute the covered software under its licenses. No warranty is provided to the extent permitted by law. The application-source snapshot does not include dependency sources; complete corresponding-source preparation is still required before public distribution.",
                             "zh": "您可按相应许可协议修改和再分发所涵盖的软件。在法律允许范围内，本软件不提供任何担保。应用源码快照不含依赖项源码；公开发行前仍须完成完整对应源码的准备。"},
    "licenses_missing":     {"en": "Packaged license materials are missing. Please report this packaging error.",
                             "zh": "发行包中缺少许可材料，请反馈此打包错误。"},
    "licenses_app_source":  {"en": "Open application-source location",
                             "zh": "打开应用源码所在位置"},
    "licenses_dev_source":  {"en": "Development checkout: application source is in this repository. No packaged source snapshot is available here.",
                             "zh": "开发环境：应用源码位于此代码仓库中，此处没有打包后的源码快照。"},
    "licenses_group_app":   {"en": "This application", "zh": "本应用"},
    "licenses_group_other": {"en": "Other packaged materials",
                             "zh": "其他随附材料"},
    "licenses_group_file":  {"en": "{n} file", "zh": "{n} 个文件"},
    "licenses_group_files": {"en": "{n} files", "zh": "{n} 个文件"},
    ...
    "prefs_motion":                 {"en": "Interface motion:", "zh": "界面动效："},
    "prefs_motion_standard":        {"en": "Standard — subtle transitions", "zh": "标准 — 轻柔过渡"},
    "prefs_motion_reduced":         {"en": "Reduced — minimal feedback", "zh": "减少 — 简洁反馈"},
    "prefs_motion_off":             {"en": "Off — instant updates", "zh": "关闭 — 即时更新"},
    "prefs_motion_hint":            {"en": "Motion affects the interface only, never figure data or exports. Standard respects Windows' reduced-animation setting. Apply to activate.",
                                      "zh": "动效仅影响界面，不改变图像数据或导出结果。标准模式遵循 Windows 的减少动画设置。点击应用后生效。"},
    "prefs_applied":                {"en": "Settings applied", "zh": "设置已应用"},
    "rastertxt_detecting":          {"en": "Detecting text…", "zh": "正在检测文字…"},
    "rastertxt_cancel":             {"en": "Cancel", "zh": "取消"},
    "rastertxt_detection_cancelled": {"en": "Detection cancelled", "zh": "已取消检测"},
    "status_layout_updated":       {"en": "Layout updated", "zh": "已更新布局"},
    ...
    "svgtxt_font_size_label":        {"en": "Final size (pt):",                "zh": "成图字号 (pt)："},
    "lbl_typography_mode":           {"en": "Text sizing:",                    "zh": "文字大小单位："},
    "typography_points":             {"en": "Final-size points",               "zh": "最终成图磅值"},
    "typography_legacy":             {"en": "Legacy (appearance preserved)",   "zh": "旧版（保留原有外观）"},
    "typography_legacy_suffix":      {"en": " legacy",                         "zh": " 旧版单位"},
    "typography_source_pt_suffix":   {"en": " source pt",                      "zh": " 源图 pt"},
    "typography_legacy_notice":      {"en": "This project retains legacy label and scale-bar sizing to preserve its appearance. These legacy values are not publication points. New projects use final-size pt. Math text and text-size groups still use pt.",
                                      "zh": "此工程保留旧版标注和比例尺字号，以维持原有外观。旧版数值不是出版磅值；新建工程使用最终成图 pt。数学文字和文字大小组仍使用 pt。"},
    "typography_points_tip":         {"en": "Font size in the final figure: 1 pt = 1/72 inch. Export DPI and canvas zoom do not change its physical size. Visible letter height depends on the font.",
                                      "zh": "最终成图字号：1 pt = 1/72 英寸。导出 DPI 和画布缩放不改变其实际大小；可见字高取决于字体。"},
    ...
    "rastertxt_regions_label":       {"en": "Text regions  (tick to enable, select to edit)",
                                      "zh": "文字区域（勾选以启用，选中以编辑）"},
    "rastertxt_size_px":             {"en": "Est. source size (px)",              "zh": "源图估计字号 (px)"},
