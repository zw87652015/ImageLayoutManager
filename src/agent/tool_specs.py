    ...
    },
    {
        ...
        "input_schema": _obj({
            ...
            "text_size_mm": {"type": "number", "exclusiveMinimum": 0,
                             "description": "Legacy scale-bar text size; use only in legacy-mode projects."},
            "text_size_pt": {"type": "number", "exclusiveMinimum": 0,
                             "maximum": 1000,
                             "description": "Final-figure font size in points; use only in points-mode projects."},
            "unit": {"type": "string",
    ...
    },
    {
        ...
        "input_schema": _obj({
            ...
            "scale_bar_text_size_mm": {"type": "number",
                                       "exclusiveMinimum": 0,
                                       "description": "Legacy scale-bar text size; use only in legacy-mode projects."},
            "scale_bar_text_size_pt": {"type": "number",
                                       "exclusiveMinimum": 0,
                                       "maximum": 1000,
                                       "description": "Final-figure font size in points; use only in points-mode projects."},
    ...
    # ── text items (free text + per-item styling) ───────────────────
    {
        ...
        "input_schema": _obj({
            ...
            "font_size_pt": {"type": "number", "exclusiveMinimum": 0,
                             "maximum": 1000,
                             "description": "Final-figure points in new projects; legacy projects retain their original size units. Check project_describe.typography_mode."},
