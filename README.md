...
- **AI/MCP 辅助排版**
  可将 Claude Desktop、Claude Code、Cursor、Windsurf、Cline 或其他 MCP 工具接入正在运行的应用。AI 可以创建布局、导入图片、调整标签/文本样式、裁剪/旋转/加边距、添加比例尺、添加 PiP 放大插图、管理尺寸组、设置导出区域、请求截图并保存/导出项目。
